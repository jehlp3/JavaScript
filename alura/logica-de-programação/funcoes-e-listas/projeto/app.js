...
function verificarChute() {
    ...
    if (chute == numSecreto) {
        ...
        document.getElementById('reiniciar').removeAttribute('disabled'); //Habilitando o botão após o acerto
    } else {
        if (chute > numSecreto) {
...
function gerarNumAleatorio() {
    ...
    if(listaNumerosSorteados.includes(numeroEscolhido)){
        ...
        listaNumerosSorteados.push(numeroEscolhido); //push coloca sempre no final
